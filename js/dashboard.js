document.addEventListener('DOMContentLoaded', () => {
    ...
    const navCustomer = document.getElementById('navShopper');
    const navArtisan = document.getElementById('navCreator');
    const navAdmin = document.getElementById('navSupplier');

    if (navCustomer) navCustomer.style.display = role === 'Shopper' ? 'block' : 'none';
    if (navArtisan) navArtisan.style.display = role === 'Creator' ? 'block' : 'none';
    if (navAdmin) navAdmin.style.display = role === 'Supplier' ? 'block' : 'none';
    ...
    const roleDefaults = {
        'Shopper': 'shopper_browse',
        'Creator': 'creator_studio',
        'Supplier': 'supplier_queue'
    };
